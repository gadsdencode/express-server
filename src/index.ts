...
// CORS setup
const allowedOrigins = ['https://kainbridge.vercel.app', 'https://kainbridge-mvp.vercel.app', 'https://kainbridge.com/coaching/', 'http://localhost:3000', 'https://kainbridge.com/', 'https://kainbridge.com/app/', 'https://kainbridge.com/coaching-2/', 'https://kainbridge.com/coach-signup/'];
app.use(cors({
